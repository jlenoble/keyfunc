...
function whichFunc(type, prop) {
  ...
  switch (type) {
    ...
    case 'object':
      return _strictfunc2.default;
      break;

    case 'literal':
      return _loosefunc2.default;
      break;

    case 'property':
      return _propertyfunc2.default.bind(undefined, prop);
      break;

    case 'array':
      return _arrayfunc2.default;
      break;

    case 'set':
      return _setfunc2.default;
      break;
