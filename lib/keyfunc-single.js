...
function singleFunc(_ref2, keyfunc) {
  ...
  if (optional) {
    return (0, _keyfuncOptional2.default)(keyfunc({ type: type, property: property, typesuffix: typesuffix, sub: sub }), { ntimes: ntimes, repeat: repeat, unordered: unordered, unique: unique });
  }
